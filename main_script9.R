...
saveRDS(results_100, file.path(output_dir, "data_50_4_3.rds"))
...
saveRDS(results_125, file.path(output_dir, "data_50_4_4.rds"))
...
saveRDS(results_150, file.path(output_dir, "data_50_4_5.rds"))
...
saveRDS(results_175, file.path(output_dir, "data_50_4_6.rds"))
